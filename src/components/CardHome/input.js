...
const Page1 = (props) => {
  ...
  return (
      ...
      <div className={styles['property-top-navogation-scroll']}>
        <div className={styles['search']}>
          ...
          />
          <div className={styles['icn-search']}>
        ...
        <img src={'https://cdn-icons-png.flaticon.com/512/147/147142.png'} className={styles['avatar']}/>
        <div
